...
export const REGRESSION_CASES: RegressionCase[] = [
  ...
  // Roles in the body, and confirmations that mention the talent pool
  r(
    'en-body-role-comma',
    '"Nordvik" <no-reply@ashbyhq.com>',
    'Thank you for applying to Nordvik',
    'Thank you for submitting your application for the Software Engineer, New Grad position at Nordvik.',
    'APPLICATION_CONFIRMATION',
    'Nordvik',
    'Software Engineer, New Grad',
  ),
  r(
    'en-apply-to-the-role',
    '"Pixelia" <no-reply@ashbyhq.com>',
    'Thanks for your interest in Pixelia!',
    'Thanks for your interest in Pixelia and for taking the time to apply to the Core Software Engineer - Infrastructure role! We will review it.',
    'APPLICATION_CONFIRMATION',
    'Pixelia',
    'Core Software Engineer - Infrastructure',
  ),
  r(
    'en-role-with-salary',
    '"Zentro" <no-reply@ashbyhq.com>',
    'Thanks for applying to Zentro!',
    'Thank you for applying for the Software Engineer (TypeScript) - Platform - 50-70K€ + BSPCE role at Zentro!',
    'APPLICATION_CONFIRMATION',
    'Zentro',
    'Software Engineer (TypeScript) - Platform',
  ),
  r(
    'en-joining-the-team',
    '"Kalm Health" <no-reply@kalmhealth.teamtailor-mail.com>',
    '👋 Alex - We have received your application!',
    'Thank you for your interest in joining the Kalm Health team! We appreciate the time you took to apply for the Fullstack Engineer position.',
    'APPLICATION_CONFIRMATION',
    'Kalm Health',
    'Fullstack Engineer',
  ),
  r(
    'fr-confirmation-talent-pool',
    'no-reply@beetween-software.com',
    'Confirmation de réception de candidature',
    'Nous avons bien reçu votre candidature. Votre CV sera conservé dans notre vivier de talents.',
    'APPLICATION_CONFIRMATION',
  ),
  r(
    'en-confirmation-talent-community',
    '"Pixelia" <no-reply@pixeliahq.com>',
    'Thank you for applying to Pixelia',
    'We have received your application. Meanwhile, join our talent community!',
    'APPLICATION_CONFIRMATION',
    'Pixelia',
  ),
  // People
